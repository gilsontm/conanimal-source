                            ...
                            <form method="POST" action="<c:url value='/profile'/>" class="w-100 px-4 py-3">
                                ...
                                <c:if test="${user.getIs_legal_person()}"> 
	                                <div class="form-group row">
	                                    ...
	                                    <div class="col-9">
	                                        <input type="text" id="company_name_input" name="company_name" class="form-control" value="${user.getCompany_name()}">
	                                    </div>
	                                </div>
                                </c:if>
                                <div class="form-group row">
                                ...
                                <c:if test="${user.getIs_legal_person()}"> 
	                                <div class="form-group row">
	                                    ...
	                                    <div class="col-9">
	                                        <input type="text" id="representative_name_input" name="representative_name" class="form-control" value="${user.getRepresentative_name()}">
	                                    </div>
	                                </div>
                                </c:if>
                                <div class="form-group row">
                                    <label for="rg_input" class="col-3 col-form-label"> ${user.getIs_legal_person() ? "RG do representante" : "RG"} </label>
                                    <div class="col-9">
                                        <input type="tel" id="rg_input" name="rg" class="form-control" value="${user.getRg()}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="cpf_input" class="col-3 col-form-label"> ${user.getIs_legal_person() ? "CPF do representante" : "CPF"} </label>
                                    <div class="col-9">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9">
                                        <input type="tel" id="cell_phone_input" name="cell_phone" class="form-control" value="${user.getCell_phone()}">
                                    </div>
                                </div>
                                <div class="form-group row">
