                    ...
                    <form name="p_register_form" method="POST" action="<c:url value='/register'/>" class="w-100 px-5 py-3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" min="0" id="p_payment_input" name="payment" class="form-control" placeholder="Contribuição mensal">
                        ...
                        <div class="form-check">
                            <label class="form-check-label text-white">
                                <input type="checkbox" id="p_agree_with_terms_checkbox" name="agree_with_terms" class="form-check-input" checked>
                                Conheço e concordo com o <a href="<c:url value='/statute'/>" class="text-white">estatuto</a>
                                e com as <a href="<c:url value='/legislation'/>" class="text-white">legislações</a> da Con Animal.
                            </label>
                            <div class="form-control-feedback"></div>
                        </div>
                ...
                <div class="tab-pane fade" id="company_tab">
                    <form name="c_register_form" method="POST" action="<c:url value='/register'/>" class="w-100 px-5 py-3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon">R$</span>
                                <input type="number" min="0" id="c_payment_input" name="payment" class="form-control" placeholder="Contribuição mensal">
                                <span class="input-group-addon">,00</span>
                            </div>
                            <div class="form-control-feedback"></div>
                        </div>
                        <div class="form-check">
                            <label class="form-check-label text-white">
                                <input type="checkbox" id="c_name_publishing_checkbox" name="name_publishing" class="form-check-input"  checked>
                                Autorizo a divulgação do meu nome no quadro associativo.
                            </label>
                            <div class="form-control-feedback"></div>
                        </div>
                        <div class="form-check">
                            <label class="form-check-label text-white">
                                <input type="checkbox"  id="c_agree_with_terms_checkbox" name="agree_with_terms" class="form-check-input" checked>
                                Conheço e concordo com o <a href="<c:url value='/statute'/>" class="text-white">estatuto</a>
                                e com as <a href="<c:url value='/legislation'/>" class="text-white">legislações</a> da Con Animal.
                            </label>
                            <div class="form-control-feedback"></div>
