            ...
            <div class="card standard-color-blue mt-0 mb-5 py-2 rounded col-4 offset-4">
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="person_tab">
                        ...
                        <form method="POST" action="<c:url value='/register'/>" class="w-100 px-5 py-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="p_name_input" name="name" class="form-control" placeholder="Nome completo">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="p_cell_phone_input" class="text-white"> Telefone celular </label>
                                ...
                                <small id="p_cell_phone_description" class="text-white">Digite apenas números e acrescente o DDD</small>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="tab-pane fade" id="company_tab">
                        <form method="POST" action="<c:url value='/register'/>" class="w-100 px-5 py-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="c_name_input" name="name" class="form-control" placeholder="Nome fantasia">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="c_cell_phone_input" class="text-white"> Telefone celular </label>
                                ...
                                <small id="c_cell_phone_description" class="text-white"> Digite apenas números e acrescente o DDD </small>
                            </div>
                            <div class="form-group">
